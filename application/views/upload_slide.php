			...
			<div class="rows_container clearfix">
				...
				<div class="row">
					<div class="col-6 offset-md-3">
						<h3>FORM UPLOAD SLIDE</h3>
						<form action="<?php echo site_url('Aksi-Tambah-Slide.getor');?>" method="post" enctype="multipart/form-data">							
							<div class="form-group">
								<label for="file">Input Gambar Slide</label>
								<input type="file" class="dropify form-control" name="filefoto" data-height="300">
								
							</div>
							<div class="form-group">
								<label for="pesan">Pesan yang akan ditampilkan di Slide</label>
