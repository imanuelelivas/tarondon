								...
								<div id="nav_menu">
									...
									<ul id="navy" class="clearfix">
										<li class="normal_menu mobile_menu_toggle current_page_item">
											<a href="<?php echo site_url('Pengurus-Website.Getor')?>"><span>Home</span></a>									
										</li><li class="normal_menu mobile_menu_toggle current_page_item">
											<a href="#"><span>Data Permohonan Doa</span></a>									
										</li>
									</li><li class="normal_menu mobile_menu_toggle current_page_item">
										<a href="https://login.yahoo.com/?done=https%3A%2F%2Fapi.login.yahoo.com%2Foauth2%2Frequest_auth%3Fclient_id%3Ddj0yJmk9NTJmMkVmOFo3RUVmJmQ9WVdrOVdXeGhVMWx3TjJFbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD01OA--%26redirect_uri%3Dhttps%253A%252F%252Fwww.flickr.com%252Fsignin%252Fyahoo%252Foauth%252F%253Fredir%253Dhttps%25253A%25252F%25252Fwww.flickr.com%25252Fphotos%25252F139534009%252540N06%25252Falbums%26response_type%3Dcode%26scope%3Dopenid%252Csdpp-w%26nonce%3D3501f9fb567d5c538f9f6f5b97f78e56%26.scrumb%3D0&crumb=.DW1cJvl3h0&redirect_uri=https%3A%2F%2Fwww.flickr.com%2Fsignin%2Fyahoo%2Foauth%2F%3Fredir%3Dhttps%253A%252F%252Fwww.flickr.com%252Fphotos%252F139534009%2540N06%252Falbums" target="_blank"><span>Manajemen Gallery</span></a>									
									</li>
								</nav>
								<!-- End Nav -->	
			...
			<section class="content_section">
				<div class="content row_spacer clearfix">
					<div class="rows_container clearfix">
						<form class="hm_contact_form full_contact_form" method="post" action="<?php echo site_url('Aksi-Renungan.getor')?>" enctype="multipart/form-data">
							<div class="col-md-12">
								<div class="main_title upper">
											<h2>
												<span class="line"><i class="ico-signup"></i></span>
												tambah
												<span class="main_title_c1">renungan</span>
											</h2>
									</div>
								</div>
								<div class="lfc_user_row">
									<label for="login_user_name">Judul</label>
										<input type="text" name="judul" class="" placeholder="masukkan Judul Renungan" required>
								</div>
								<div class="lfc_user_row">
									<label for="login_user_name">Isi Renungan</label>
										<textarea name="renungan" id="renungan" rows="10" cols="10" required></textarea>
								
								<script>
									CKEDITOR.replace( 'renungan' );
								</script>
								</div>
								<div class="lfc_user_row">
									<label for="login_user_name">Gambar</label>
								...
								<div class="lfc_user_row">
										...
										<a href="<?php echo site_url('Pengurus-Website.Getor');?>" class="btn btn-default">Kembali</a>
								</div>
